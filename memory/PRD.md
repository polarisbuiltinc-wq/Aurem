...
**On prod as of 2026-02-12 (Batch 6 deploy at built_at `18:14:28`, SHA `07fd53b0db78`)**:
- All Batches 1-6 shipped. **Cumulative: 54 sites / 21 service
  files migrated onto `services/http` wrapper.**
  - Batch 1 (11 sites): topup_alerts, mermaid_diagram,
    mock_reality_check, integration_health (8 probes)
  - Batch 2 (4 sites): advisor_vision, financials, daily_digest,
    url_fetcher
  - Batch 3 (7 sites): mode_d_debugger, tools_bridge,
    web_skills (4 safe sites)
  - Batch 4 (13 sites · all `github` dep): graph_builder,
    repo_context, local_tools, repo_heal
  - Batch 5 (12 sites): supabase_provisioner, dev_skills
    (with new `npm`/`pypi` deps)
  - Batch 6 (7 sites): github_deploy_service, billing_cron,
    finding_fix_applier, github_issues_context
