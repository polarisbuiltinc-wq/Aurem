...
### Next: Phase 2c coverage wave starts on `backend/routers/codebase_health.py` (founder-selected, lowest baseline ~10%, monitoring/health-score compounding value) per founder's explicit sequencing.
