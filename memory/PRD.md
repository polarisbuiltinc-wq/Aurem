...
**Confidence**: CONFIRMED for snapshot/preview/ledger/gating (real E2E + independent tests). Write-side restore path: code-complete, fail-closed proven, success path UNPROVEN until writable credential provided. No UI yet — admin cockpit widget is follow-up scope.
