...
import { Cloud, Check, AlertCircle, ChevronDown, Lock } from "lucide-react";
import { api } from "../lib/api";
import { VercelTryItRow } from "./VercelTryItRow";
...
export default function VercelCard() {
  ...
  return (
    <section className="card" data-testid="settings-vercel"
      ...
      {status?.connected && (
        <VercelTryItRow
          tools={tools} tool={tool} setTool={setTool}
          args={args} setArgs={setArgs} busy={busy} runTool={runTool}
