...
export default function MermaidBlock({ code, title }) {
  ...
  // Render mermaid SVG via ref to avoid dangerouslySetInnerHTML.
  // `svg` is produced by `mermaid.render` (which we initialised
  // with securityLevel: 'strict' — it strips event handlers +
  // arbitrary HTML).
  useEffect(() => {
