...
<script>
  try {
    ...
    else { const p = document.createElement('pre'); p.textContent = 'No exported component found. Define a function named App or export default.'; document.getElementById('root').appendChild(p); }
  } catch (e) {
    const p = document.createElement('pre'); p.textContent = (e && e.message || e); document.getElementById('root').appendChild(p);
  }
</script>
</body></html>`;
  }
...
<script>
  try {
    ...
    ${code}
    if (log.length) { const p = document.createElement('pre'); p.textContent = log.join('\\n'); document.getElementById('output').appendChild(p); }
  } catch (e) {
    const p = document.createElement('pre'); p.textContent = (e && e.message || e); document.getElementById('output').appendChild(p);
  }
</script>
</body></html>`;
}
