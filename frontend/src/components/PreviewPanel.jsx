...
<script>
  try {
    ...
    else { const _p = document.createElement('pre'); _p.textContent = 'No exported component found. Define a function named App or export default.'; document.getElementById('root').appendChild(_p); }
  } catch (e) {
    const _p = document.createElement('pre'); _p.textContent = ''+(e && e.message || e); document.getElementById('root').appendChild(_p);
  }
</script>
</body></html>`;
  }
...
<script>
  try {
    ...
    ${code}
    if (log.length) { const _p = document.createElement('pre'); _p.textContent = log.join('\\n'); document.getElementById('output').appendChild(_p); }
  } catch (e) {
    const _p = document.createElement('pre'); _p.textContent = ''+(e && e.message || e); document.getElementById('output').appendChild(_p);
  }
</script>
</body></html>`;
}
