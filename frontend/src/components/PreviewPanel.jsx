...
<script>
  try {
    ...
    else { const _r = document.getElementById('root'); _r.textContent = ''; const _p = document.createElement('pre'); _p.textContent = 'No exported component found. Define a function named App or export default.'; _r.appendChild(_p); }
  } catch (e) {
