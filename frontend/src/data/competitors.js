...
export const COMPETITORS = {
  ...
  devin: {
    slug: "devin",
    name: "Devin",
    title: "AUREM CTO vs Devin (2026) — honest comparison | Devin alternative",
    description:
    ...
    pricingProse: [
      ...
      "250 ACUs, then $2.00 per additional ACU. AUREM CTO is a flat fee: Free is " +
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Devin bills by Agent Compute Units: the $20/month Core plan charges " +
           ...
           "AUREM CTO is a flat fee with generous task caps — Pro is $19/month " +
  ...
  cursor: {
    slug: "cursor",
    name: "Cursor",
    title: "AUREM CTO vs Cursor (2026) — honest comparison | Cursor alternative",
    description:
      "AUREM CTO vs Cursor, compared honestly: autonomous AI engineer that ships " +
    ...
    intro:
      ...
      "in the IDE and steer every change. AUREM CTO is an autonomous engineer — " +
    ...
    pricingProse: [
      ...
      "AUREM CTO is a flat fee: Free is 10 tasks/month, Starter is $9 for 50 " +
    ...
    faq: [
      {
        q: "Is AUREM CTO a Cursor alternative or a different kind of tool?",
        a: "Different kind. Cursor is an AI-powered IDE where you do the driving; " +
           "AUREM CTO is an autonomous AI engineer that takes a task description, " +
      ...
      {
        q: "How does AUREM CTO's pricing compare to Cursor's?",
        a: "Cursor runs $20 (Pro) to $200 (Ultra) per month with usage quotas per " +
           "tier; Teams is $40 per user. AUREM CTO is flat: $0 free tier, $9 " +
      ...
      {
        q: "Can I use AUREM CTO together with Cursor?",
  ...
  "github-copilot": {
    slug: "github-copilot",
    name: "GitHub Copilot",
    title: "AUREM CTO vs GitHub Copilot (2026) — honest comparison | Copilot alternative",
    description:
      "AUREM CTO vs GitHub Copilot, compared honestly: autonomous task shipping vs " +
    ...
    pricingProse: [
      ...
      "AUREM CTO is a flat fee per month — Free 10 tasks, Starter $9/50 tasks, " +
    ...
    faq: [
      {
        q: "Is AUREM CTO an alternative to GitHub Copilot?",
        a: "For autocomplete, no — Copilot owns in-IDE completions. For getting " +
           "whole tasks done and shipped, yes: AUREM CTO reads your repo, writes " +
      ...
      {
        q: "How does AUREM CTO's pricing compare to Copilot's?",
        a: "Copilot Pro is $10/month and Pro+ is $39/month with 1,500 premium " +
           ...
           "from that meter. AUREM CTO charges flat per month for task outcomes: " +
      ...
      },
      {
        ...
        a: "Copilot itself does not gate its output behind a security scan; " +
           ...
           "scanning). AUREM CTO runs Vanguard 2.0 on every change before it " +
  ...
  "replit-agent": {
    slug: "replit-agent",
    name: "Replit Agent",
    title: "AUREM CTO vs Replit Agent (2026) — honest comparison | Replit alternative",
    description:
      "AUREM CTO vs Replit Agent, compared honestly: shipping to YOUR GitHub repo " +
    ...
    intro:
      ...
      "brilliant for zero-setup prototypes. AUREM CTO works on the repositories " +
    ...
    pricingProse: [
      ...
      "cost more. AUREM CTO bills flat per month for task outcomes: $0 free, $9 " +
    ...
    faq: [
      {
        q: "Is AUREM CTO an alternative to Replit Agent?",
        a: "Yes, when your code lives on GitHub. Replit Agent shines when you " +
           ...
           "workspace. AUREM CTO is for the repos you already run in production: " +
  ...
  windsurf: {
    slug: "windsurf",
    name: "Windsurf",
    title: "AUREM CTO vs Windsurf (2026) — honest comparison | Windsurf alternative",
    description:
      "AUREM CTO vs Windsurf, compared honestly: autonomous task shipping to GitHub " +
    ...
    intro:
      ...
      "editor. AUREM CTO is an autonomous engineer that takes tasks from any " +
    ...
    pricingProse: [
      ...
      "feet mid-quarter. AUREM CTO stays flat: $0 free, $9 Starter (50 tasks), " +
    ...
    faq: [
      {
        q: "Is AUREM CTO a Windsurf alternative?",
        a: "They solve different moments. Windsurf's Cascade makes you faster " +
           "inside the editor; AUREM CTO removes the editor from the loop for " +
      ...
      {
        q: "How does AUREM CTO's pricing compare to Windsurf's?",
        a: "Windsurf moved to quota-based plans in March 2026 — Free, $20/month " +
           "Pro, $40/user Teams, with daily/weekly usage quotas. AUREM CTO is " +
      ...
      },
      {
        ...
        a: "Windsurf does not advertise a pre-commit security gate. AUREM CTO " +
      ...
      },
      {
        ...
        a: "If you live in an editor and want the smoothest supervised agent " +
           ...
           "off tasks from anywhere and receive verified commits, choose AUREM CTO.",
      },
    ],
  },
};
...
export const COMPARE_HUB = {
  title: "AUREM CTO vs Devin, Cursor, Copilot, Replit & Windsurf (2026) — honest comparisons",
  description:
    "How AUREM CTO compares to Devin, Cursor, GitHub Copilot, Replit Agent and " +
