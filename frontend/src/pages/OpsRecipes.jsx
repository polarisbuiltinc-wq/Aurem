...
const RECIPES = [
  {
    ...
    escalate: "If `systemctl status` shows 'Failed' for 3+ consecutive restarts, message auremcto.com/support with the last 100 lines of /var/log/supervisor/supervisord.log",
  },
  {
    id: "service-logs",
  ...
  return (
    <div style={{ padding: "24px 32px", maxWidth: 920, margin: "0 auto",
      ...
      <div style={{ fontSize: 11, color: "var(--text-faint)",
        ...
        Missing a recipe? Message us at auremcto.com/support — we'll add it.
      </div>
    </div>
  );
}
