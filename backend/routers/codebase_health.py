...
def _security_fix_hint(rule_id: str) -> str:
    mapping = {
        ...
        "eval_usage":        "Replace dynamic code execution with `ast.literal_eval` or an explicit parser.",
        "exec_usage":        "Replace dynamic code execution with a safer dispatch (dict of callables).",
