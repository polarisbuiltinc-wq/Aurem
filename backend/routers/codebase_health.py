...
def _security_fix_hint(rule_id: str) -> str:
    mapping = {
        ...
        "eval_usage":        "Replace the eval builtin with `ast.literal_eval` or an explicit parser.",
        "exec_usage":        "Replace the exec builtin with a safer dispatch (dict of callables).",
