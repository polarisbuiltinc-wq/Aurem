...
# ─────────────────────────────────────────────────────────────────────
#  Iter 212m-177/178 — P0-3: automatic task_type inference now lives in
#  `core.task_type` (no heavy imports) so routers can use it without
#  pulling the Parliament stack. Re-exported here for compatibility.
# ─────────────────────────────────────────────────────────────────────
from core.task_type import infer_task_type  # noqa: E402,F401
