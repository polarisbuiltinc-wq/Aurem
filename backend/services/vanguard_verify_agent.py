...
React raw-HTML injection in a tooltip, etc.). The regex floor
...
Review the patch for ALL of these dimensions:
  ...
  5. Cross-site scripting — innerHTML, raw HTML injection props, raw
...
SEVERITY RULES (Iter 212m-41 — production calibration):
  ...
  HIGH     = real risk but needs preconditions (e.g. user already
             ...
             raw HTML injection of a static literal string.
