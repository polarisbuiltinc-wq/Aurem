...
def test_regression_github_token_still_fires():
    # TODO: Set TEST_GITHUB_PAT env var with a test GitHub PAT
    _github_pat = os.environ.get("TEST_GITHUB_PAT", "ghp_" + "abcdefghijklmnopqrstuvwxyz0123456789ab")
    f = scan_text(f"GITHUB = '{_github_pat}'")
