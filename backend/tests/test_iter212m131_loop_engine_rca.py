...
def test_verify_self_heal_timeout_doesnt_hang(monkeypatch):
    ...
    # W3 · 2026-08 — first heal-exhaustion pauses for user (Iter309
    # source of truth, reinstated). See
    # test_iter_feb2026_verify_terminal_fail.py::
    # test_verify_pauses_once_then_hard_fails_on_reentry_no_duplicate
    # for the full first-pause/retry-reentry-hard-fail contract.
